var GPS_Ninja = require('./lib/gpsninja')
  , util = require('util')
  , stream = require('stream')
  , configHandlers = require('./lib/config-handlers');

// Give our driver a stream interface
util.inherits(gpsninja,stream);
...
function gpsninja(opts,app) {
  ...
  app.on('client::up',function(){
    ...
    // Register a device
    self.emit('register', new GPS_Ninja());
  });
};
 ...
 */
gpsninja.prototype.config = function(rpc,cb) {
